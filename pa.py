...
class BasePA:
    ...
    def __init__(self, C, mode, fit_intercept, data):
        self.C = C
...
class PARegressor(BasePA, base.Regressor):
    ...
    def __init__(self, C=1.0, mode=1, eps=0.1, fit_intercept=True,data=[]):
        super().__init__(C=C, mode=mode, fit_intercept=fit_intercept,data=data)
